...
const ProductDetails = () => {
  ...
  if (loading) return <div className="text-center text-xl text-white p-8">Loading product...</div>

  if (error) return <div className="text-center text-xl text-yellow-300 p-8">Error: {error}</div>

  if (!product) return <div className="text-center text-xl text-white/70 p-8">No product found</div>
